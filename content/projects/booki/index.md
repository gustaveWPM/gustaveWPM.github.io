...
topics: ['HTML', 'CSS', 'OpenClassrooms', 'Débutant']
...
**Vous pouvez également prévoir un onglet de [:link: ChatGPT](https://chat.openai.com), [:link: Perplexity](https://perplexity.ai), ou autre outil IA de votre choix. De mon point de vue, je pense qu'il ne faut pas hésiter à faire appel à ces outils.**  
...
Cela permet aussi de se focaliser sur **l'un des points les plus essentiels dans tout projet de dév' : savoir raisonner du code**.
...
<p align="center" class="wpm fake-figcaption"><em>Vous n'écrirez plus jamais votre code HTML de la même manière...</em></p>
...
{{< alert "circle-info" >}}
Testez vos _meta description_ et _title_ grâce à un [:link: Google SERP Simulator](https://mangools.com/free-seo-tools/serp-simulator) !
{{< /alert >}}
...
{{< gallery >}}
  <img src="./assets/capture-ecran-booki-version-telephone-1.webp" class="grid-w25" alt="Capture d'écran de la version mobile de la page d'accueil de Booki (1/4)" />
  <img src="./assets/capture-ecran-booki-version-telephone-2.webp" class="grid-w25" alt="Capture d'écran de la version mobile de la page d'accueil de Booki (2/4)" />
  <img src="./assets/capture-ecran-booki-version-telephone-3.webp" class="grid-w25" alt="Capture d'écran de la version mobile de la page d'accueil de Booki (3/4)" />
  <img src="./assets/capture-ecran-booki-version-telephone-4.webp" class="grid-w25" alt="Capture d'écran de la version mobile de la page d'accueil de Booki (4/4)" />
{{< /gallery >}}
